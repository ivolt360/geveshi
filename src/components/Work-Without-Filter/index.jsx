            ...
            <div className="col-md-6 items">
              <div className="item">
                ...
                <div className={`cont ${vis ? "vis" : ""}`}>
                  ...
                  <span>Modern</span>
                  <h5>
                    <Link href="/project-details">Concept Development</Link>
                  </h5>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 items">
              <div className="item">
                ...
                <div className={`cont ${vis ? "vis" : ""}`}>
                  ...
                  <span>Modern</span>
                  <h5>
                    <Link href="/project-details">residential sketchup 3d</Link>
                  </h5>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 items">
              <div className="item">
                ...
                <div className={`cont ${vis ? "vis" : ""}`}>
                  ...
                  <span>Modern</span>
                  <h5>
                    <Link href="/project-details">Finiwaage Holiday Retreat</Link>
                  </h5>
                </div>
              </div>
            </div>
